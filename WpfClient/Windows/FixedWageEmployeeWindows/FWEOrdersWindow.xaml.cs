...
{
    /// <summary>
    /// Interaction logic for FixedWageEmployeeOrdersWindow.xaml
    /// </summary>
    public partial class FWEOrdersWindow : Window, IParameteredWindow<FixedWageEmployee>
    {
        public FWEOrdersWindow()
        {
            InitializeComponent();
            Loaded += (_, _) =>
            {
        ...
        {
            Loaded += (_, _) => (DataContext as FWEOrdersViewModel)?.Setup(item);
        }
    }
}
