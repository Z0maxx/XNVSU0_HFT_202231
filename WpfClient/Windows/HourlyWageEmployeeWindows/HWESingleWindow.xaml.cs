...
{
    /// <summary>
    /// Interaction logic for HourlyWageEmployeeSingleWindow.xaml
    /// </summary>
    public partial class HWESingleWindow : Window, IParameteredWindow<HourlyWageEmployee>
    {
        public HWESingleWindow()
        {
            InitializeComponent();
            Loaded += (_, _) =>
            {
        ...
        {
            Loaded += (_, _) => (DataContext as HWESingleViewModel)?.Setup(item);
        }
    }
}
